 ...
 * backs {@code doom.TechDoomChain} ("Chains of Despair")'s first debuff stage, replacing this project's
 ...
 * once the effect actually ends by {@code doom.TechDoomChain.AbilityRestoreEvents} - see that class's own doc comment for
 * why this effect can't restore the field itself.
 */
