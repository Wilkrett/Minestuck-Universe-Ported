...
public class TimelineData implements INBTSerializable<CompoundTag>
{
	...
	private final java.util.List<org.wilkretawesomesauce.minestuckuniverseported.mechanics.timeline.vision.PastVisionSession> activeVisions = new java.util.ArrayList<>();
	private final java.util.List<org.wilkretawesomesauce.minestuckuniverseported.mechanics.timeline.loop.TimeLoopZone> activeLoops = new java.util.ArrayList<>();
	...
	public java.util.List<org.wilkretawesomesauce.minestuckuniverseported.mechanics.timeline.loop.TimeLoopZone> getActiveLoops()
	{
		return activeLoops;
	}
	 ...
	 */
	public java.util.List<org.wilkretawesomesauce.minestuckuniverseported.mechanics.timeline.vision.PastVisionSession> getActiveVisions()
	{
