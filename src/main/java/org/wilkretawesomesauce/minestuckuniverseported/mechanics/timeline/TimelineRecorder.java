 ...
 * loaded level, unconditionally - real added baseline cost, bounded by {@link Config#timelineHistoryTicks}
	...
	private static void onLevelTick(LevelTickEvent.Post event)
	{
		...
		for(Entity entity : level.getAllEntities())
			if(entity instanceof LivingEntity living)
				snapshots.put(living.getUUID(), EntitySnapshot.of(living));

		dataOf(level).pushTick(snapshots, Config.timelineHistoryTicks);
	}
}
